  ...
  return (
    <View style={styles.container}>
      {navigation.canGoBack() && (
        <Pressable style={[styles.backBtn, { marginTop: insets.top + 12 }]} hitSlop={10} onPress={() => navigation.goBack()}>
          <Text style={styles.backBtnText}>‹ back</Text>
        </Pressable>
      )}
      <Text style={[styles.title, navigation.canGoBack() ? styles.titleWithBack : { marginTop: insets.top + 12 }]}>bookmarks</Text>
      {loading ? (
...
const styles = StyleSheet.create({
  ...
  // Same bordered button as the other screens, above the title.
  backBtn: {
