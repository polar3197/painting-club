...
import { Profile, MemberRole, get_profile, set_member_role, profilePicThumbSource } from '../api';
...
export default function UserRoleDetail() {
  ...
  const pic = profilePicThumbSource(profile);
  const name =
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top + 24 }]}>
      <View style={styles.head}>
        {pic ? (
          <Image source={pic} cachePolicy="memory-disk" style={styles.pic} />
        ) : (
